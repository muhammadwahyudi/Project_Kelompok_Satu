                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="actions">                                                
                                                    <a  class="btn btn-xs btn-warning" href="javascript:;"
                                                        ...
                                                        data-kodebarang="<?php echo $result[$i][1]; ?>"
                                                        data-namabarang="<?php echo $result[$i][2]; ?>"
                                                        data-jumlah="<?php echo $result[$i][3]; ?>"
                                                        data-satuan="<?php echo $result[$i][4]; ?>"
            ...
            <div id="tambah-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="form-data" method="post" action="../controler/barang.php?p=tambah">
                            ...
                            <div class="modal-body">
                                ...
                                <fieldset>
                                    ...
                                    <br>
                                    <div class="control-group">
                                        <span class="label label-success">Nama Barang</span>
                                        <div class="controls">
                                            <input type="text" name="namabarang" class="form-control" name="namabarang" id="namabarang">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        <span class="label label-success">Satuan</span>
                                        <div class="controls">
            ...
            <div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="form-data" class="form-edit" method="post" action="../controler/barang.php?p=update">
            ...
            <div id="import" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="form-data" method="post" action="../controler/barang.php?p=import" enctype="multipart/form-data">
...
?>
                                    ...
                                    var div = $(event.relatedTarget) // Tombol dimana modal di tampilkan
                                            ...
                                            modal.find('#hapus-true').attr("href", "../controler/barang.php?p=hapus&id=" + id);
                                    });
                                            // Untuk sunting
                                    ...
                                    var div = $(event.relatedTarget) // Tombol dimana modal di tampilkan
                                            ...
                                            var namabarang = div.data('namabarang');
                                            ...
                                            modal.find('#namabarang').attr("value", namabarang);
