...
$result = $o_pembelian->select_pembelian();
...
window.location.href = uri + base64(format(template, ctx))
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="m-b-30">
                                            <button class="btn btn-primary waves-effect waves-light" data-id='0' data-toggle="modal" data-target="#tambah-data-pembelian"><i class="fa fa-plus"></i> Tambah pembelian</button>
                                            <button class="btn btn-primary waves-effect waves-light" data-id='0' data-toggle="modal" data-target="#tambah-data-penjualan"><i class="fa fa-plus"></i> Tambah penjualan</button>
            ...
            <div id="tambah-data-pembelian" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">

                        <form id="form-data" method="post" action="../controler/transaksi.php?p=beli">
                            ...
                            <div class="modal-body">
                                ...
                                <fieldset>
                                    ...
                                    <br>
                                    <div class="control-group">
                                        <span class="label label-success">jenis transaksi</span>
                                        <div class="controls">
                                            <select name="jenistransaksi" id="jenistransaksi" class="form-control select2" style="width: 100%">
                                    ...
                                    <br>
                                    <div class="control-group">
                                        <span class="label label-success">tanggal transaksi</span>
                                        <div class="controls">
                                    ...
                                    <br>
                                    <div class="control-group">
                                        <span class="label label-success">keterangan</span>
                                        <div class="controls">
                                            <input type="lock" name="keterangan" class="form-control" id="keterangan">
                                        </div>
                                    </div>
            ...
            <!-- Modal tambah data pembelian -->
            <div id="tambah-data-penjualan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">

                        <form id="form-data" method="post" action="../controler/transaksi.php?p=jual">
            ...
            <div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="form-data" class="form-edit" method="post" action="../controler/pembelian.php?p=update">
                            ...
                            <div class="modal-body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <span class="label label-success">Jenis Transaksi</span>
                                        <!--<div class="controls">
                                            <input type="text" name="Jenistransaksi" class="form-control" name="Jenistransaksi" id="Jenistransaksi">
                                        </div>-->
                                        <div class="controls">
                                                        <select name="Jenistransaksi" id="Jenistransaksi" class="form-control select2" style="width: 100%">
                                                            <!--<option value="0">--Pilih kode--</option>-->
                                                            <?php
                                                            $Jenistransaksi = $o_barang->select_barang();
                                                            for ($i = 0; $i < count($Jenistransaksi); $i++) {
                                                                ?> 
                                                                <option value="<?php echo $Jenistransaksi[$i][1]; ?>"><?php echo $Jenistransaksi[$i][1]; ?></option>
                                                            <?php } ?>
                                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <span class="label label-success">Tanggal Transaksi</span>
                                        <div class="controls">
                                            <input type="number" name="tanggaltransaksi" class="form-control" id="tanggaltransaksi">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <span class="label label-success">Keterangan</span>
                                        <div class="controls">
                                            <input type="date" name="keterangan" class="form-control" id="keterangan">
                                        </div>
                                    </div>
            ...
            <div id="import" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="form-data" method="post" action="../controler/pembelian.php?p=import" enctype="multipart/form-data">
...
?>
                                    ...
                                    $(".progress-container").show();
                                            ...
                                            if (data.trim() == "Menghapus" || data.trim() == "Mengedit" || data.trim() == data.trim()) {
                                            ...
                                            if (data.trim() == "beli" || data.trim() == data.trim()) {

                                            $(".progress-bar").attr('style', 'width:100%');
                                                    setTimeout(function() {
                                                    window.location.replace("trans_pembelian.php")
                                                    }, 500);
                                            }

                                            if (data.trim() == "jual" || data.trim() == data.trim()) {
                                    ...
                                    var div = $(event.relatedTarget) // Tombol dimana modal di tampilkan
                                            ...
                                            modal.find('#hapus-true').attr("href", "../controler/pembelian.php?p=hapus&id=" + id);
                                    });
                                            // Untuk sunting
                                    ...
                                    var div = $(event.relatedTarget) // Tombol dimana modal di tampilkan
                                            ...
                                            var Jenistransaksi = div.data('Jenistransaksi');
                                            var tanggaltransaksi = div.data('tanggaltransaksi');
                                            ...
                                            modal.find('#Jenistransaksi').attr("value", Jenistransaksi);
                                            modal.find('#tanggaltransaksi').attr("value", tanggaltransaksi);
