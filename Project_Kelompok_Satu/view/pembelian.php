                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="m-b-30">
                                            <!--<button class="btn btn-primary waves-effect waves-light" data-id='0' data-toggle="modal" data-target="#tambah-data"><i class="fa fa-plus"></i> Tambah pembelian</button> -->
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="actions">                                                
                                                    <a  class="btn btn-xs btn-warning" href="javascript:;"
                                                        ...
                                                        data-kodetransaksi="<?php echo $result[$i][1]; ?>"
                                                        data-kodebarang="<?php echo $result[$i][2]; ?>"
                                                        data-jumlahmasuk="<?php echo $result[$i][3]; ?>"
                                                        data-tanggalmasuk="<?php echo $result[$i][4]; ?>"
                        ...
                        <form id="form-data" method="post" action="../controler/pembelian.php?p=tambah">
                            ...
                            <div class="modal-body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <span class="label label-success">tanggal masuk</span>
                                        <div class="controls">
...
?>
                                    ...
                                    var div = $(event.relatedTarget) // Tombol dimana modal di tampilkan
                                            ...
                                            var tanggal masuk = div.data('tanggalmasuk');
                                            var modal = $(this)
