                    ...
                    <div class="container">
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="m-b-30">
                                            ...
                                            <button class="btn btn-primary waves-effect waves-light" data-id='0' data-toggle="modal" data-target="#tambah-data"><i class="fa fa-plus"></i> Tambah barang</button>
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 0;
                                            ...
                                            $con = mysqli_connect('localhost','root','','db_pergudangan') OR die(mysql_error());
                                            $ambil = mysqli_query($con, "SELECT * from `pembelian` where kodetransaksi='$hasil'");
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="actions">                                                
                                                    <a  class="btn btn-xs btn-warning" href="javascript:;"
                                                        ...
                                                        data-jumlahmasuk="<?php echo $masuk[3]; ?>"
                                                        data-tanggalmasuk="<?php echo $masuk[4]; ?>"
                                ...
                                <table align="right"><tr><td><a href="pembelian.php"><button class="btn btn-primary waves-effect waves-light" data-id='0' data-toggle="modal" data-target="pembelian.php"><i class="fa "></i> selesai</button></a></td></tr></table>
                            </div>
                            <!-- end: page -->
            ...
            <div id="tambah-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="form-data" method="post" action="../controler/pembelian.php?p=tambah">
                            ...
                            <div class="modal-body">
                                ...
                                <fieldset>
                                    ...
                                    <br>
                                    <div class="control-group">
                                        <span class="label label-success">jumlah masuk</span>
                                        <div class="controls">
                                            <input type="number" name="jumlahmasuk" class="form-control" id="jumlahmasuk">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <span class="label label-success">tanggal keluar</span>
                                        <div class="controls">
                        ...
                        <form id="form-data" class="form-edit" method="post" action="../controler/pembelian.php?p=update">
                            ...
                            <div class="modal-body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <span class="label label-success">tanggalmasuk</span>
                                        <div class="controls">
                                            <input type="date" name="tanggalmasuk" class="form-control" id="tanggalmasuk">
                                        </div>
                                    </div>
...
?>
                                    ...
                                    var div = $(event.relatedTarget) // Tombol dimana modal di tampilkan
                                            ...
                                            var jumlahmasuk = div.data('jumlahmasuk');
                                            var tanggalmasuk = div.data('tanggalmasuk');
                                            var modal = $(this)
                                            ...
                                            modal.find('#jumlahmasuk').attr("value", jumlahmasuk);
                                            modal.find('#tanggalmasuk').attr("value", tanggalmasuk);
                                    });
                                    });</script>
